...
for module in modules:
    html_path = api_output_dir / "ARTcore" / f"{module}.html"
    remove_module_name_div(html_path)

# Generate markdown files from pdoc HTML files
api_content_dir = here / "src" / "content" / "ARTcoreAPI"
...
site_output_dir = here / "src" / "content" / "ARTcoreAPI" / ".html"
